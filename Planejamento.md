...
- [x] **Sistema de Usuários:** Cadastro e Login de usuários.
- [x] **Autenticação JWT:** Proteger as rotas de escrita (Post/Put/Delete) para que apenas usuários autenticados possam alterar dados.
- [x] **Middleware de Permissão:** Garantir que um usuário só possa editar/deletar os livros da sua própria estante.
